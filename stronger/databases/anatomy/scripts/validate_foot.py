#!/usr/bin/env python3
"""Validation utility for foot configuration files."""
...
CONFIG_DIR = Path(__file__).resolve().parents[4] / "config" / "anatomy" / "foot"
FILES = {
...
def main(argv: Sequence[str]) -> int:
    ...
    print("Foot anatomy configuration is consistent.")
    return 0
