#!/usr/bin/env python3
"""Validation utility for abdomen configuration files."""
...
CONFIG_DIR = Path(__file__).resolve().parents[4] / "config" / "anatomy" / "abdomen"
FILES = {
...
def main(argv: Sequence[str]) -> int:
    ...
    print("Abdomen anatomy configuration is consistent.")
    return 0
