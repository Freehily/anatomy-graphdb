#!/usr/bin/env python3
"""Validation utility for head and neck configuration files."""
...
CONFIG_DIR = Path(__file__).resolve().parents[1] / "configs" / "head_and_neck"
FILES = {
...
def main(argv: Sequence[str]) -> int:
    ...
    print("Head and neck anatomy configuration is consistent.")
    return 0
