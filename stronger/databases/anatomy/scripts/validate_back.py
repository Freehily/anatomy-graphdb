#!/usr/bin/env python3
"""
Validation utility for back configuration files.
"""
...
CONFIG_DIR = Path(__file__).resolve().parents[4] / "config" / "anatomy" / "back"
FILES = {
...
def main(argv: Sequence[str]) -> int:
    ...
    print("Back anatomy configuration is consistent.")
    return 0
